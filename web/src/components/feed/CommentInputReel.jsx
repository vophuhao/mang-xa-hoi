...
const CommentInputReel = ({
    ...
    return (
        <div className=" dark:border-gray-700 w-[300px]">
            {/* Reply indicator */}
            {parentId && (
            ...
            <form onSubmit={handleSubmit} className="flex items-center space-x-3 ">
                {/* Input Container */}
                <div className="relative flex-1 border border-gray-300  bg-white px-3 py-1 dark:border-gray-600 dark:bg-gray-900 rounded-full">
                    <div className="flex items-center">
                        ...
                        <button
                            type="button"
                            data-emoji-button
                            className={`ml-2 p-1 transition-colors ${showEmojiPicker
                            ...
                            <div className="flex border-b border-gray-100 dark:border-gray-700">
                                {[
                                    ...
                                    <button
                                        ...
                                        className={`flex-1 p-2 text-center transition-colors ${activeEmojiCategory === category.key
                ...
                <button
                    ...
                    className={`rounded-full  transition-colors duration-200 ${content.trim() && !isAddingComment
...
export default CommentInputReel;
