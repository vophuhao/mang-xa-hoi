...
const additionalPosts = [
  ...
  // Video posts
  {
    caption: "Watch this amazing time-lapse of the sunrise! 🌅 Nature is incredible 🎥",
    mediaUrls: ["https://sample-videos.com/zip/10/mp4/SampleVideo_1280x720_1mb.mp4"],
    mediaType: "video",
    tags: ["timelapse", "sunrise", "nature", "video"],
    likeCount: 455,
    commentCount: 67,
    shareCount: 34,
    viewCount: 3421,
  ...
  {
    caption: "Cooking tutorial: Perfect pasta in 5 minutes! 🍝👨‍🍳 Follow along!",
    mediaUrls: ["https://sample-videos.com/zip/10/mp4/SampleVideo_640x360_1mb.mp4"],
    mediaType: "video",
    tags: ["cooking", "tutorial", "pasta", "food"],
    likeCount: 678,
    commentCount: 89,
    shareCount: 45,
    viewCount: 5234,
  ...
  {
    caption: "My cat being adorable as always 😸🐱 She loves playing with this toy!",
    mediaUrls: ["https://sample-videos.com/zip/10/mp4/SampleVideo_720x480_1mb.mp4"],
    mediaType: "video",
